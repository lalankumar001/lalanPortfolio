...
import ProfilePic from '../../Assets/AboutSectionPic.png'
import UiUx from '../../Assets/UiUx.gif'
import web from '../../Assets/webDev.gif'
import content from '../../Assets/contentWriter.gif'
...
const Home = () => {
  ...
  return (
    <div>
      ...
      {/* Dark Mode toggler Here */}
      <div>
        <h6 className={styles['darkModeToggle']} title='Theme Toggler' ><MdLightMode onClick={darkModeHandler} /></h6>
      </div>
      {/* Home page About Section is here , in nav bar about component is differnt */}
      <div className={styles['AboutSection']}>
        <div className='container row p-5 text-secondary'>
          <div className='col'>
            <img src={ProfilePic} alt="img" title="Yeah, That's me" className='shadow rounded' />
          </div>
          <div className='col'>
            <h3>Discover</h3>
            <h1><b className='text-decoration-underline'>Ab</b>out Me</h1>
            <h5><b>Hi!..</b>My Name is Lalan Kumar. I'm a Front-End Developer based in New Delhi ,India and i'm very passionate and dedicated to my work.
              with bachelor's degree, I have acquired the skills necessary to build great and premium website</h5>
            {/* About section table  */}
            <div>
              <table className="table table-dark">
                <tbody>
                  <tr>
                    <th scope="row"><FaUserAlt /></th>
                    <td colspan="2" className="table-active">Name: Lalan Kumar</td>
                    <td className='text-info'> New Delhi , India  </td>
                  </tr>
                  <tr>
                    <th scope="row"><FaUserGraduate /></th>
                    <td colspan="2" className="table-active">Bachelor of Computer Applications</td>
                    <td className='text-info '>2019 - 2022</td>
                  </tr>
                  <tr>
                    <th scope="row"><FaSchool /></th>
                    <td colspan="2" className="table-active">Maharaja Surajmal Institue , New Delhi</td>
                    <td><a href="https://www.msijanakpuri.com/" target="_blank" className='btn btn-dark text-info' rel="noopener noreferrer">MSI Janakpuri</a></td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className='container'>
              <a href="https://drive.google.com/file/d/1JuQV5XhUT-wzRLQ_Vebyv58ZSLb0fLQs/view?usp=share_link" target="_blank" className='btn btn-info' rel="noopener noreferrer">DOWNLOAD CV</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className='container mt-1 p-2'>
        <h3 className='p-3 fs-1 fw-bold shadow rounded text-secondary'>What I do ?</h3>
        <div className='container row p-1'>
          <div className='col rounded shadow'>
            <img src={UiUx} alt="" width='250' className='shadow rounded-pill mx-5 my-1 p-3' />
          ...
          <div className='col rounded shadow'>
            <img src={web} alt="" width='250' className='shadow rounded-pill mx-5 my-1 p-4' />
          ...
          <div className='col rounded shadow'>
            <img src={content} alt="" width='250' className='shadow rounded-pill mx-5 my-1 p-3' />
            <h2>Technical Content Writing</h2>
      ...
      {/* Work Section start here in Home page */}
          ...
          <div className='col shadow'>
            <div className="card text-center">
              <div className="card-header row">
                ...
                <div className='col'>
                  <a href="https://altcode-bb81f.web.app/" target='_blank' className="btn btn-primary">LIVE</a>
                </div>
          ...
          <div className='col p-5 mx-5 '>
            <div className="card text-center w-100 ">
              <div className="card-header row">
                ...
                <div className='col'>
                  <a href="https://mail-box-client-eight.vercel.app/" target='_blank' className="btn btn-primary">LIVE</a>
                </div>
                <div className='col text-info'>
                  <h3><IoLogoGithub /></h3>
                </div>
          ...
          <div className='col'>
            <div className="card text-center">
              <div className="card-header row">
                ...
                <div className='col'>
                  <a href="https://e-commerce-nine-gilt.vercel.app/" target="_blank" className="btn btn-primary">LIVE</a>
                </div>
                <div className='col text-info'>
                  <h3><IoLogoGithub /></h3>
                </div>
          ...
          <div className='col p-5 mx-5 shadow'>
            <div className="card text-center w-100 ">
              <div className="card-header row">
                ...
                <div className='col'>
                  <a href="https://expense-tracker-with-redux.vercel.app/" target="_blank" className="btn btn-primary">LIVE</a>
                </div>
                <div className='col text-info'>
                  <h3><IoLogoGithub /></h3>
                </div>
      ...
      <hr className='text-info' />
      {/* Project / work section end here */}
      <br />
      {/* IT SKILLS SECTION START HERE   */}
      <div className='p-5'>
        <h1 className='p-3 shadow rounded text-secondary'>My Skills</h1>
        <h1 className='text-primary text-center pb-3'> <b>Technical</b> Skills</h1>
        <div className='container row mx-5 p-4 border border-primary shadow rounded-pill'>
          <div className='col'>
            <h1 className='w-50'>
            ...
            <h3 className='text-info fs-6'>Html</h3>
          </div>
          ...
          <div className='col'>
            ...
            <h3 className='text-info fs-6'>Css</h3>
          </div>
          ...
          <div className='col'>
            ...
            <h3 className='text-info fs-6'>JavaScript</h3>
          </div>
          ...
          <div className='col'>
            ...
            <h3 className='text-info fs-6'>Tailwindcss</h3>
          </div>
          ...
          <div className='col'>
            ...
            <h3 className='text-info fs-6'>Bootstrap</h3>
          </div>
          ...
          <div className='col'>
            ...
            <h3 className='text-info fs-6'>MaterialUi</h3>
          </div>
          ...
          <div className='col'>
            ...
            <h3 className='text-info fs-6'>ReactJs</h3>
          </div>
          ...
          <div className='col'>
            ...
            <h3 className='text-info fs-6'>Redux</h3>
          </div>
{/*second row start here  */}
          <div className='row mt-5 p-1'>
            ...
            <h3 className='text-info fs-6'>git</h3>
            </div>
 
            <div className='col'>
             {/* <h1 className='text-white w-100 fs-1'> <IoLogoGithub /> </h1> */}
            <h1 className='w-50'>  
            <svg viewBox="0 0 128 128">
            ...
            <h3 className='text-info fs-6'>Github</h3>
            </div>
            ...
            <h3 className='text-info fs-6'>Firebase</h3>
            </div>
            ...
            <h3 className='text-info fs-6'>Figma</h3>
            </div>
            ...
            <h3 className='text-info fs-6'>MySql</h3>
            </div>
            ...
            <h3 className='text-info fs-6'>Java</h3>
            </div>
            ...
            <h3 className='text-info fs-6'>Wordpress</h3>
            </div>
            ...
            <h3 className='text-info fs-6'>NodeJs</h3>
            </div>
          </div>
        </div>
      </div>
{/* ContactMe Section Here */}
      <div className='container'>
