...
import { MdLightMode, MdOutlineAddLink ,MdOutlineMailOutline} from "react-icons/md";
import { FaUserAlt, FaUserGraduate, FaSchool, FaExternalLinkAlt, FaArrowAltCircleRight ,FaTwitter} from "react-icons/fa";
      ...
      <div className={styles.Hero}>
        <h1>Hi , I'm Lalan Kumar
          ...
          <div className='row ' id={styles['SocalMedia']}>
            ...
            <div className='col-1 '>
              <a href="https://twitter.com/Lalan_kumar001?t=Iit0hQtuQDzU1zFKYQ7juw&s=09" target="_blank" rel="noopener noreferrer" alt="Social Icon">
                <FaTwitter/>
              </a>
            </div>
